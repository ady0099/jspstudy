...
<body>
	<%--
		액션 태그 : JSP 페이지 간에 흐름 제어, 자바빈즈 컴포넌트 지원, ...
		사용법 : <jsp: 액션태그>
		예)
			...
			1. include : 현재 페이지에서 다른 페이지를 호출 또는
				...
				- include 액션 태그 : <jsp:include page="가져올 페이지"></jsp:include>
				제어권을 해당 페이지에 넘겨서 일처리를 한 후 결과를 가져온다.
	...
	<jsp:inlcude page="ex04_request.jsp"></jsp:inlcude>
</body>
</html>